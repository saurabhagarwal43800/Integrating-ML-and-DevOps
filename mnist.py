...
while accuracy < 90 :
    ...
    for i in range(counter) :
            model.add(Dense(units=random.choice([128,256,512,1024]),activation="relu",input_shape=(784,)))
      
    counter = counter +1
    print("counter is ",counter)
    
    model.add(Dense(units=10,activation="softmax"))      
    learning_rate = random.choice([0.1,0.01,0.001,0.0001]) #learning_rate/10
